    ...
    return (
        <HeaderContainer>
            ...
            {location.pathname === "/map"
                ?  <FilterWrapper>
                    <Filter options={voivodeships} placeholder={process.env.REACT_APP_PLACEHOLDER_1}/>
                    <Filter options={renderFiltersCategoryOptions()} placeholder={process.env.REACT_APP_PLACEHOLDER_2}/>
                </FilterWrapper>
                : null
            }
            <LinksWrapper>
